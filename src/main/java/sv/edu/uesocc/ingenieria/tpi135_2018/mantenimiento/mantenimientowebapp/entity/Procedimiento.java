...
@NamedQueries({
    ...
    , @NamedQuery(name = "Procedimiento.findByNombreLike", query = "SELECT DISTINCT p FROM Procedimiento p WHERE UPPER(p.nombre) LIKE UPPER(:name)")
...
public class Procedimiento implements Serializable {
    ...
    public String toString() {
        return "sv.edu.uesocc.ingenieria.tpi135_2018.mantenimiento.mantenimientowebapp.entity.Procedimiento[ idProcedimiento=" + idProcedimiento + " ]";
    }
