 ...
 */
@Entity
@Table(name = "diagnostico", catalog = "mantenimiento", schema = "public")
@XmlRootElement
@NamedQueries({
...
public class Diagnostico implements Serializable {
    ...
    public String toString() {
        return "sv.edu.uesocc.ingenieria.tpi135_2018.mantenimiento.mantenimientowebapp.entity.Diagnostico[ idDiagnostico=" + idDiagnostico + " ]";
    }
