 ...
 */
@Stateless
public class OrdenCalendarioFacade extends AbstractFacade<OrdenCalendario> implements OrdenCalendarioFacadeLocal {
    ...
    public OrdenCalendarioFacade() {
        super(OrdenCalendario.class);
    }
