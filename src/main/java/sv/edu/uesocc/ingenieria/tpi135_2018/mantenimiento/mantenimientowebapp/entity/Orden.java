...
@NamedQueries({
    ...
    , @NamedQuery(name = "Orden.findByActivo", query = "SELECT o FROM Orden o WHERE o.activo = true")
    , @NamedQuery(name = "Orden.findByInactivo", query = "SELECT o FROM Orden o WHERE o.activo = false")})
