 ...
 */
@Entity
@Table(name = "marca", catalog = "mantenimiento", schema = "public")
@XmlRootElement
@NamedQueries({
    ...
    , @NamedQuery(name = "Marca.findByNombreLike", query = "SELECT DISTINCT a FROM Marca a WHERE UPPER(a.nombre) LIKE UPPER(:name)")
...
public class Marca implements Serializable {
    ...
    public String toString() {
        return "sv.edu.uesocc.ingenieria.tpi135_2018.mantenimiento.mantenimientowebapp.entity.Marca[ idMarca=" + idMarca + " ]";
    }
