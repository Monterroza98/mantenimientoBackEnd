 ...
 */
@Entity
@Table(name = "responsable", catalog = "mantenimiento", schema = "public")
@XmlRootElement
@NamedQueries({
...
public class Responsable implements Serializable {
    ...
    public String toString() {
        return "sv.edu.uesocc.ingenieria.tpi135_2018.mantenimiento.mantenimientowebapp.entity.Responsable[ idResponsable=" + idResponsable + " ]";
    }
